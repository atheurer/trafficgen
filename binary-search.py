                  ...
                  if m:
                       ...
                       for device_pair in trial_params['test_dev_pairs']:
                            ...
                            if trial_params['use_device_stats']:
                                 ...
                                 print("Device Pair: %s |   All TX   | packets=%d rate=%f l1_bps=%f" % (direction_string, stats[device_pair['tx']]['tx_packets'], stats[device_pair['tx']]['tx_pps'], stats[device_pair['tx']]['tx_l1_bps']))
                                 print("Device Pair: %s |   All RX   | packets=%d rate=%f l1_bps=%f" % (direction_string, stats[device_pair['rx']]['rx_packets'], stats[device_pair['rx']]['rx_pps'], stats[device_pair['rx']]['rx_l1_bps']))
                            ...
                            if trial_params['measure_latency']:
                                 ...
                                 print("Device Pair: %s | Latency TX | packets=%d rate=%f l1_bps=%f" % (direction_string, stats[device_pair['tx']]['tx_latency_packets'], stats[device_pair['tx']]['tx_latency_pps'], stats[device_pair['tx']]['tx_latency_l1_bps']))
                                 print("Device Pair: %s | Latency RX | packets=%d rate=%f l1_bps=%f average=%f maximum=%f" % (direction_string, stats[device_pair['rx']]['rx_latency_packets'], stats[device_pair['rx']]['rx_latency_pps'], stats[device_pair['rx']]['rx_latency_l1_bps'], stats[device_pair['rx']]['rx_latency_average'], stats[device_pair['rx']]['rx_latency_maximum']))
